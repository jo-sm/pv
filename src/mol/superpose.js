...
var calculateCov = function(subjectAtoms, referenceAtoms, subjectCenter, referenceCenter, covariance) {
...
export var superpose = function(structure, reference) {
...
//  * ['aname1', 'aname2']  to  { 'aname1', 'aname2' }
export function parseAtomNames(atoms) {
  var results = {};
...
export function addAtomsPresentInBoth(inA, inB, outA, outB, atomSet) {
...
export function matchResiduesByIndex(inA, inB, atoms) {
  return matchResidues(inA, inB, atoms, function(chainA, chainB) {
    return [chainA.residues(), chainB.residues()];
  });
}

export function matchResiduesByNum(inA, inB, atoms) {
  return matchResidues(inA, inB, atoms, function(chainA, chainB) {
    var outA = [];
    var outB = [];
