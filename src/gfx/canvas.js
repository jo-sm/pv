export function isWebGLSupported(gl) {
...
export class Canvas {
  ...
  _initManualAntialiasing(samples) {
  ...
  _shaderFromString(shader_code, type, precision) {
    var shader;
    var gl = this._gl;
    if (type === 'fragment') {
  ...
  initShader(vert_shader, frag_shader, precision) {
    var gl = this._gl;
    ...
    var getAttribLoc = gl::gl.getAttribLocation;
    var getUniformLoc = gl::gl.getUniformLocation;
  ...
  onWheel(firefoxHandler, handler) {
